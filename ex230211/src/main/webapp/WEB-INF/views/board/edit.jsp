...
<script type="text/javascript">
    $(function() {
        ...
        $(".list-btn").click(function() {
        	var result = confirm("목록으로 이동하면 수정중인 내용이 저장되지 않습니다.\n정말 이동하시겠습니까?");
	...
	<div class="container-800">
		<form action="edit" method="post">
			...
			<div class="row flex">
				...
				<c:choose>
					<c:when test="${boardParent == null}">
						<input type="text" name="boardTitle" value="${boardDto.boardTitle}" class="form-input small w-100" placeholder="제목을 입력하세요."><br>
					</c:when>
					<c:otherwise>
						<input type="text" name="boardTitle" value="RE: ${boardDto.boardTitle}" class="form-input small w-100" placeholder="제목을 입력하세요."><br>
					</c:otherwise>
				</c:choose>
			</div>
			<div class="row">
			...
			<div class="row flex">
	            ...
	            <div class="w-50 right">
	                <button type="submit" class="form-btn small positive w-20 edit-btn">수정하기</button>
	            </div>
	        </div>
     	</form>
    </div>
