package com.exercise.ex230207.controller;
...
import com.exercise.ex230207.dao.LecturesDao;
import com.exercise.ex230207.dto.LecturesDto;
...
public class ExController {
	...
	public String delete(@RequestParam int no) {
		boolean delete = lecturesDao.delete(no);
		if(delete) {
			return "삭제가 완료되었습니다.";
		}
		else {
